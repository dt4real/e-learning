    ...
    <div className="text-black dark:text-white">
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than E-Learning, the premier programming community dedicated
          ...
          <br />
          <br />
          With E-Learning by your side, there&apos;s nothing standing between you
          ...
          <br />
          <br />
          So what are you waiting for? Join the E-Learning family today and let&apos;s
        ...
        <br />
        <span className="text-[22px]">Darlington Otchere&apos;s</span>
        <h5 className="text-[18px] font-Poppins">
          Fullstack Devloper at E-Learning
        </h5>
        <br />
        <br />
        <br />
